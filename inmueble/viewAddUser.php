        ...
        <div id="contenedor">
            ...
            <div id="body">
                <div id="body-center">	
                    ...
                    <div class="campo">
                        <br/>
                        <form action="phpInsertUser.php" method="POST" enctype="multipart/form-data">                                      
                            ...
                            <br/>
                            Introduce email valido. Se te enviara un email con un link para activar el anuncio<br/>
                            <br/>
