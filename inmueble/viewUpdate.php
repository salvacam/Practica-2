                ...
                <div id="body-center">	
                    ...
                    <div class="campo">
                        ...
                        <form action="phpUpdate.php" method="POST" enctype="multipart/form-data">                                                       
                            ...
                            <br/>
                            <br/>
                            <?php echo $modeloProvincia->selectHtml("provincia", "provincia", "1=1", array(), "'".$inmueble->getProvincia()."'", $inmueble->getProvincia(), TRUE, "Elige Provincia"); ?>
                            <input type="text" name="direccion" value="<?php echo $inmueble->getDireccion(); ?>" id="direccion" placeholder="direccion" />
                            <input type="text" name="ciudad" value="<?php echo $inmueble->getCiudad(); ?>" id="ciudad" placeholder="ciudad" />    
                            <br/>
                            <br/>
                            ...
                            <input type="checkbox" name="isactivo" id="isactivo" <?php if ($inmueble->getIsactivo() == 1) echo "checked=''"; ?>/>                            
